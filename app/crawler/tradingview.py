...
def search_payload(query: str) -> Dict[str, Any]:
    return {
        ...
        "markets": [
            ...
            "colombia","uae","nigeria","singapore","germany","peru","poland",
            "italy","argentina","israel","egypt","serbia","chile","china",
            "malaysia","ksa","bahrain","qatar","indonesia","finland","iceland",
            "denmark","romania","hungary","sweden","slovakia","lithuania",
            "luxembourg","estonia","latvia","vietnam","rsa","thailand",
            "korea","norway","philippines","greece","venezuela"
        ],
...
def search(query: str) -> List[Dict[str, str]]:
    ...
    for item in items:
        id = item.get('s')
        symbol, name, price, sector, industry, currency, exchange, country = item.get('d')
